...
| 2026-05-02 08:00 | beaver-agent | Captured exception variable in _test_connection and _post_event handlers - enables error string logging instead of silent failures | 87 tests passing |
